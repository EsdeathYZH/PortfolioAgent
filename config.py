...
class Config:
    ...
    # Server酱/Web推送API 配置
    serverchan_send_key: Optional[str] = None  # API Key（从 URL 提取或直接配置）
    serverchan_channel: Optional[str] = None   # 推送通道（可选，如 "9|66"）
    serverchan_noip: bool = False              # 是否隐藏IP（默认 false）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            serverchan_noip=os.getenv('SERVERCHAN_NOIP', 'false').lower() == 'true',
