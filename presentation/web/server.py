...
class WebServer:
    ...
    def __init__(self, host: str = "127.0.0.1", port: int = 8000, router: Optional[Router] = None):
        """
        初始化 Web 服务器
...
def run_server_in_thread(
    host: str = "127.0.0.1", port: int = 8000, router: Optional[Router] = None
) -> threading.Thread:
    """
    在后台线程启动 WebUI 服务器
...
def run_server(host: str = "127.0.0.1", port: int = 8000, router: Optional[Router] = None) -> None:
    """
    前台运行 WebUI 服务器（阻塞）
