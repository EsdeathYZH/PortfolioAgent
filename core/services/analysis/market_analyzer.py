...
从market_analyzer.py迁移的MarketAnalyzer类
"""
...
class MarketAnalyzer:
    ...
    def _get_main_indices(self) -> List[MarketIndex]:
        ...
        try:
            ...
            df = self._call_akshare_with_retry(lambda: ak.stock_zh_index_spot_sina(), "指数行情", attempts=2)
    ...
    def _get_market_statistics(self, overview: MarketOverview):
        ...
        try:
            ...
            # 获取全部A股实时行情
            df = self._call_akshare_with_retry(lambda: ak.stock_zh_a_spot_em(), "A股实时行情", attempts=2)
    ...
    def _get_sector_rankings(self, overview: MarketOverview):
        ...
        try:
            ...
            # 获取行业板块行情
            df = self._call_akshare_with_retry(lambda: ak.stock_board_industry_name_em(), "行业板块行情", attempts=2)
        ...
        try:
            ...
            for query in search_queries:
                ...
                response = self.search_service.search_stock_news(
                    stock_code="market", stock_name="大盘", max_results=3, focus_keywords=query.split()
                )
